...
import { Loader2, Brain, Sparkles, Layers, Zap, Target, Globe } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center mb-12 animate-fade-in">
            ...
            <p className="text-xl text-textSecondary mb-8 leading-relaxed">
              Explore any topic through AI-powered visual knowledge maps. From historical events to scientific
              breakthroughs, discover connections and insights like never before.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto animate-slide-up">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-elevated border border-surface/50">
              <div className="mb-6">
                <label htmlFor="prompt" className="block text-sm font-semibold text-textPrimary mb-3">
              ...
              {/* Example prompts */}
              <div className="mb-6">
                <div className="text-sm font-medium text-textSecondary mb-3">Popular topics:</div>
              ...
              <div className="mb-8">
                <div className="text-sm font-semibold text-textPrimary mb-3">Map Detail Level</div>
                <RadioGroup
                ...
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="minimal" id="minimal" className="border-2" />
                    <Label htmlFor="minimal" className="cursor-pointer font-medium">
                      Essential
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="moderate" id="moderate" className="border-2" />
                    <Label htmlFor="moderate" className="cursor-pointer font-medium">
                      Balanced
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="thorough" id="thorough" className="border-2" />
                    <Label htmlFor="thorough" className="cursor-pointer font-medium">
                      Comprehensive
                    </Label>
                  </div>
                </RadioGroup>
                <div className="text-xs text-textSecondary mt-2">
                  {complexityLevel === "minimal" && "Focus on the most important elements and core relationships."}
                  {complexityLevel === "moderate" && "Balanced coverage with key elements and meaningful connections."}
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              <div className="text-center group">
                ...
                <h3 className="font-heading text-xl font-semibold text-textPrimary mb-3">Universal Knowledge</h3>
                <p className="text-textSecondary leading-relaxed">
                  Explore any domain - from ancient history to cutting-edge science, literature to technology
                </p>
              </div>
              <div className="text-center group">
                ...
                <h3 className="font-heading text-xl font-semibold text-textPrimary mb-3">Smart Connections</h3>
                <p className="text-textSecondary leading-relaxed">
                  AI discovers hidden relationships and patterns across complex knowledge domains
                </p>
              </div>
              <div className="text-center group">
                ...
                <h3 className="font-heading text-xl font-semibold text-textPrimary mb-3">Adaptive Detail</h3>
                <p className="text-textSecondary leading-relaxed">
                  Control complexity from simple overviews to comprehensive deep-dive explorations
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="container mx-auto flex justify-between items-center">
              <div>
                ...
                <p className="text-textSecondary">
                  {displayData.nodes?.length || 0} elements • {displayData.edges?.length || 0} relationships
                </p>
              </div>
              <Button
                variant="outline"
